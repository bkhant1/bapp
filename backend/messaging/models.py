...
class BookDiscussion(models.Model):
    ...
    book = models.ForeignKey('books.Book', on_delete=models.CASCADE, related_name='discussions')
...
class MessageAttachment(models.Model):
    ...
    message = models.ForeignKey(PrivateMessage, on_delete=models.CASCADE, related_name='attachments')
